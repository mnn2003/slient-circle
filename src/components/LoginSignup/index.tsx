...
export function LoginSignup(props: ILoginSignupProps) {
  ...
  function getHeader() {
    return (
      <div style={headerStyle(theme)}>
        <div style={headerTitle(theme)}>
          <span>comet</span>
          <span style={chatHeaderTextStyle()}>chat</span>
        </div>
        <div style={versionStyle(theme)}>v{metaInfo.version}</div>
      </div>
    );
  }
  ...
  function getContent() {
    return (
      <div style={contentContainerStyle()}>
        <div style={contentStyle(isMobileView)}>
  ...
  function getFooter() {
    return <div style={footerStyle(theme)}></div>;
  }
